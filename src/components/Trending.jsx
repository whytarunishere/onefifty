          ...
          <li key={item._id || index} className="cursor-pointer group border-b border-[#ECECEC] pb-4 last:border-b-0 last:pb-0">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="font-serif text-lg font-bold text-[#111111] group-hover:text-[#D92D20] transition-colors line-clamp-2">
                  {item.headline || (item.content ? item.content.split(' ').slice(0, 7).join(' ') + '...' : 'Untitled print')}
                </p>
              </div>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#8f8f8f] shrink-0">Trending</span>
            </div>
